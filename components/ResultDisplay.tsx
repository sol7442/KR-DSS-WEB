...
import { CheckCircleIcon, XCircleIcon, ClipboardIcon, ClipboardCheckIcon } from './Icons';
...
const ResultDisplay: React.FC<ResultDisplayProps> = ({ type, message, signatureResult }) => {
